...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		addLocalData = function() {
			...
			total = ts.p.rowTotal && ts.p.rowTotal > queryResults.length ? ts.p.rowTotal : queryResults.length,//total = queryResults.length,
		...
		setPager = function (pgid, tp){
			...
			$('.ui-pg-selbox',"#"+pgcnt).bind('change',function() {
				...
				$(ts).triggerHandler("jqGridPagerStateChange", []);
				populate();
				return false;
			});
			if(ts.p.pgbuttons===true) {
